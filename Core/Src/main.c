...
//volatile int16_t robomas[r_f-1].actVel;
//volatile int16_t robomas[r_b-1].actVel;
...
//volatile int16_t robomas[l_b-1].cu=0;
//volatile int16_t robomas[r_f-1].sa_cu=0;
//volatile int16_t robomas[r_b-1].sa_cu=0;
